...
public class MyClass {
    ...
    public static void main(String[] args) {
        ...
        try {
            File payloadSrcFile = new File("entrylib/source/source.apk");   //需要加壳的程序
            System.out.println("apk size:" + payloadSrcFile.length());
            File unShellDexFile = new File("entrylib/source/shell.dex");    //解客dex
            ...
            String str = "entrylib/source/classes.dex";
